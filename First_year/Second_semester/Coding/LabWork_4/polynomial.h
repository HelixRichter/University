...
public:
    ...
    */
     ...
     * [ВОЗВРАЩАЕТ]: вывод объекта-многочлена в командую строку.
    */

    friend std::ostream & operator << (std::ostream &out, const polynomial &expression_temp);

    /* Перегруженный оператор приведения vector-массива в выражение.
     * [ПРИНИМАЕТ]: vector-массив, требуемый для преобразования.
